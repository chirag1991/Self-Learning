    ...
    public class EditModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try 
            {
                ...
                {
                    connection.Open();
                    string sql = "SELECT * FROM dbo.clients WHERE id =@id";
        ...
        public void OnPost()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    //string sql = "UPDATE dbo.clients SET name='amit', email='am@df.com', phone='1234567890', address='lhgasfhdjsfllkj' WHERE id=7";
                    string sql = "UPDATE dbo.clients SET name=@name, email=@email, phone=@phone, address=@address WHERE id=@id";
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
